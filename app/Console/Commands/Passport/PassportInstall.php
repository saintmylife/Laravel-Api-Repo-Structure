...
class PassportInstall extends Command
{
    ...
    public function handle()
    {
        ...
        $this->call('generate:secret-client', ['--personal' => true, '--name' => config('app.name') . ' Personal Access Client']);
        $this->call('generate:secret-client', ['--password' => true, '--name' => config('app.name') . ' Password Grant Client', '--provider' => $provider]);
    }
