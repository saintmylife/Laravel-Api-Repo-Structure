...
class Create extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'service:create {name : Define Create Module Name}';
    /**
    ...
    protected function replaceClass($stub, $name)
    {
        if(Str::contains($name, 'Create')){
            $name = Str::before($this->argument('name'), 'Create');
        }
    ...
    {
        $relativePath = '/../../stubs/Domain/Service/create.stub';
    ...
    {
        return [
            ['name', InputArgument::REQUIRED, 'The name of the Create Service Files'],
        ];
    }
}
